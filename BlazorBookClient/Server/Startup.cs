...
using BlazorBookClient.Server.Helpers;
using BlazorBookClient.Server.Mappings;
using BlazorBookClient.Server.Models;
using BlazorBookClient.Server.SQL;
...
namespace BlazorBookClient.Server
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IBookAuthorRepository, SQLBookAuthorRepository>();
